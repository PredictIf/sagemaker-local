...
tensorflow-p36() {
    ...
    docker build -t dataquadrant/sagemaker-notebook-2024:tensorflow-p36 -f envs/docker/Dockerfile.tensorflow_p36 envs
}
...
python3-tensorflow-p36() {
    ...
    docker build -t dataquadrant/sagemaker-notebook-2024:python3-tensorflow-p36 -f envs/docker/Dockerfile.python3_tensorflow_p36 envs
}

all-python3() {
    # docker build -t dataquadrant/sagemaker-notebook:${PREFIX}-all-python3 -f envs/docker/Dockerfile.all_python3 envs
    docker build -t dataquadrant/sagemaker-notebook-2024:all-python3 -f envs/docker/Dockerfile.all_python3 envs
}
